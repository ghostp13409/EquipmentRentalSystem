...
using Midterm_EquipmentRental_Group2.Hubs;
...
// Ensure configuration picks up environment variables from .env
...
.AddGoogle(o =>
{
    ...
    if (string.IsNullOrEmpty(clientId) || string.IsNullOrEmpty(clientSecret))
    {
        ...
        Console.WriteLine("Warning: Google ClientId or ClientSecret is missing.");
    }
